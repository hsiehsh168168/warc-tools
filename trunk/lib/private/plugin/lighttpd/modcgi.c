 ...
 * 
 * Sends a distant listing of the records in the warc file in html format
 */
                                                                                     ...
                                                                                     warc_u32_t offset)
{
  ...
  fprintf (stdout, "<warcfile name=\"%s\" size=\"%llu\">\r\n", (const char *) fname, (unsigned long long)WFile_getFileSize (w) );   
   ...
   while (WFile_hasMoreRecords (w) )
      ...
      fprintf (stdout, "offset=\"%llu\" ", (unsigned long long) WRecord_getOffset (record) );
      fprintf (stdout,  "compressed-size=\"%llu\" ", (unsigned long long) WRecord_getCompressedSize (record) );
      fprintf (stdout, "uncompressed-size=\"%llu\" ", (unsigned long long) WRecord_getUncompressedSize (record) );
                                                                                     ...
                                                                                     warc_u32_t offset)
{
  ...
  fprintf (stdout, "warcfile : name=\"%s\" size=\"%llu\" \r\n", (const char *) fname , (unsigned long long)WFile_getFileSize (w) );   
   ...
   while (WFile_hasMoreRecords (w) )
      ...
      fprintf (stdout,  "\t* Compressed size: %llu\r\n", (unsigned long long) WRecord_getCompressedSize (record) );
                                                                                     ...
                                                                                     warc_u32_t offset)
{
  ...
  fprintf (stdout, "{\"warcfile\":[{\"name\":\"%s\"},{\"size\":\"%llu\"},{\"records\":[", (const char *) (fname), 
                                                                 (unsigned long long)WFile_getFileSize (w)); 
