...
##   wrecord.py                                                      ##
##                                                                   ##
##   A Python wrapping class for the WRecord C class of the warc     ##
##                                                                   ##
...
##The setters ##
	...
	def setContentFromFileName(self, name, name_len):
		return warc.WRecord_setContentFromFileName(self.me, name, name_len)
