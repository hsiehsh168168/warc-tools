/* 
 * - Use "wport.h" for better portability
 * - include the new <tiger.h> header file
 * - check endianness from <wport.h>
...
#define compress \
      ...
      key_schedule \
      pass(b,c,a,9) \
      for(pass_no=3; pass_no<TIGER_PASSES; pass_no++) { \
        key_schedule \
	pass(a,b,c,9) \
...
#define compress \
      save_abc \
      for(pass_no=0; pass_no<TIGER_PASSES; pass_no++) { \
