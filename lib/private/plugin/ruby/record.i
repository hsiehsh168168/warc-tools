...
/*   extern int WRecord_getAnvlField (const void * const , const unsigned int , const char ** , const char **);*/
    ...
    extern unsigned int WRecord_setContentFromString (void *, const char *, const unsigned int);
    
    extern unsigned int  WRecord_setContentFromStringConcat (void *, const char *, const unsigned int);
